...
CONFIG = {
    ...
    'num_workers': 4, # Added for dataloader
    'pin_memory': True # Added for dataloader
}
...
# --- 8. Helper function for distributed checks ---
def is_main_process():
    """Determines if the current process is the main one in a distributed setup."""
...
# --- 10. Save Model and Test Results ---
